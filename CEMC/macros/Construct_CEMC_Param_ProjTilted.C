...
//  const int n_sector = 1;
  ...
  const double azimuthal_tilt = -0.9; // -0.1; July-2017 design use 90mrad tilt in the azimuth. See Dan's talk https://indico.bnl.gov/conferenceDisplay.py?confId=3459
